        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div>
            <h1 className="text-4xl md:text-6xl font-bold mb-6 bg-gradient-to-r from-blue-400 to-purple-500 text-transparent bg-clip-text w-full md:w-[90%] lg:w-[100%]">
              Atendimento inteligente com a JulIA: mais pedidos, menos complicação
            </h1>
            <p className="text-xl text-gray-300 mb-8">
              Gerencie pedidos, responda clientes automaticamente e otimize o atendimento do seu restaurante com nossa IA especializada para delivery.
            </p>
