        ...
        <main>
          ...
          <section className="container mx-auto px-4 py-16 md:py-24">
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div>
                <h1 className="text-4xl md:text-6xl font-bold mb-6 bg-gradient-to-b from-[#C78E22] to-[#E00A0A] bg-clip-text text-transparent">
              ...
              <div className="relative flex justify-center">
                <img className="w-full max-w-[800px]" src="/images/Delivery.png" alt="Atendimento virtual para restaurantes" />
              </div>
            </div>
          </section>
